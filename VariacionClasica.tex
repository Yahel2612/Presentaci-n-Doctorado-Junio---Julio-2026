...
\begin{frame}[shrink=20]{Variación total y variación acotada}
...
\begin{block}{Lema}
{\small Sean $f,g \in BV[a,b]$, $c\in\mathbb{R}$. Entonces:
\begin{enumerate}
...
\begin{frame}[shrink=10]{$BV[a,b]$ como espacio de Banach}
...
\begin{frame}[shrink=10]{Teorema de descomposición de Jordan}
...
{\small ¿Cuándo se puede garantizar una descomposición análoga cuando
...
\begin{frame}[shrink=10]{¿Qué cambia al pasar a funciones vectoriales?}
