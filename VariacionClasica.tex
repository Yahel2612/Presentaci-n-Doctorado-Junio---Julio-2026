...
\]
Si $V_a^b(f)<\infty$, decimos que $f$ es de \textbf{variación acotada} en $[a,b]$.
\end{definition}

\medskip

Denotamos $BV[a,b] = \bigl\{f:[a,b]\to\mathbb{R} : V_a^b(f)<\infty\bigr\}$.
...
\framesubtitle{Estructura del espacio $BV[a,b]$}
...
\begin{frame}{Teorema de descomposición de Jordan}
