...
\framesubtitle{Las propiedades Generador y Normal son independientes}

\begin{center}
\begin{tikzpicture}[scale=0.85]
  %% Contenedor — Espacios normados ordenados
  \draw[rounded corners=8pt, fill=gray!6, draw=gray!45, thick]
       (-4.8,-1.8) rectangle (4.8,2.0);
  \node[gray!55, font=\footnotesize\bfseries] at (0,1.73)
       {Espacios normados ordenados};

  %% Elipse Generador (izquierda)
  \begin{scope}
    \clip (-4.8,-1.8) rectangle (4.8,2.0);
    \fill[MyTeal, opacity=0.22] (-1.4,0) ellipse (2.8 and 1.2);
  \end{scope}
  \draw[MyTeal!70, thick] (-1.4,0) ellipse (2.8 and 1.2);
  \node[MyTeal!85!black, font=\small\bfseries, align=center]
       at (-3.1,0) {Conos\\generadores};

  %% Elipse Normal (derecha)
  \begin{scope}
    \clip (-4.8,-1.8) rectangle (4.8,2.0);
    \fill[Amber, opacity=0.22] (1.4,0) ellipse (2.8 and 1.2);
  \end{scope}
  \draw[Amber!80, thick] (1.4,0) ellipse (2.8 and 1.2);
  \node[Amber!80!black, font=\small\bfseries, align=center]
       at (3.1,0) {Conos\\normales};

  %% Etiqueta intersección
  \node[font=\footnotesize\bfseries, gray!60, align=center]
       at (0,0.15) {Gen.\ y};
  \node[font=\footnotesize\bfseries, gray!60, align=center]
       at (0,-0.3) {Normal};
\end{tikzpicture}
